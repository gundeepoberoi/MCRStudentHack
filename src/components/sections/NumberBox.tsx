    ...
    return (
        <div className="flex flex-col items-center mt-4 px-2">
            <div className=" relative bg-transparent flex flex-col items-center justify-center rounded-lg w-32 h-32 text-2xl md:text-4xl mt-4 ">
                ...
                <div className=" rounded-b-lg rounded-t-lg bg-[#05556C] w-full h-full"></div>

                <div className={`absolute w-full h-1/2 top-0 rounded-t-lg z-5 ${flip ? 'animate-flip bg-cyan-950' : 'bg-transparent'}`}></div>
                {/* Two Small Dots */}
            ...
            <p className="text-lg mt-3 font-semibold text-cyan-400 md:text-2xl ">
                {unit}
            </p>
        </div>
    )
